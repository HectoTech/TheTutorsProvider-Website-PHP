...
<div class="main-header">
            ...
            <textarea name="AdmChat" cols="30" rows="10" placeholder="Type your message Here..!" required></textarea>
            <input type="submit" class="btn btn-primary butt" name="ChatSendAdmin" id="" value="Send">               
            <form>
            <br />
            <?php
            $Student_id = 0;
